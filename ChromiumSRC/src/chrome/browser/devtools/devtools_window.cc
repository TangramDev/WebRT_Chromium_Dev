...
void DevToolsWindow::ToggleDevToolsWindow(
  ...
  // ::PostAppMessage(::GetCurrentThreadId(), WM_CHROMEDEVTOOLMSG, 1, 0);
...
void DevToolsWindow::DoAction(const DevToolsToggleAction& action) {
  switch (action.type()) {
    ...
    case DevToolsToggleAction::kToggle:
      // begin Add by TangramTeam
//      if (action.type() == DevToolsToggleAction::kShow) {
// #define WM_CHROMEDEVTOOLMSG (WM_USER + 0x00004037)
//        ::PostAppMessage(::GetCurrentThreadId(), WM_CHROMEDEVTOOLMSG, 2, 0);
//      }
      // end Add by TangramTeam
      // Do nothing.
      break;
