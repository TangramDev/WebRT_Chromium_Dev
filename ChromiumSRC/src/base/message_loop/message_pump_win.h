...
class AppMessagePumpForUI {
 public:
  ...
  virtual ~AppMessagePumpForUI() {}
  virtual void OnAppIdle() {}
  virtual int OnProcessNextWindowsMessage(LPMSG lpMsg);
...
class BASE_EXPORT MessagePumpWin : public MessagePump {
 public:
  ...
  // begin Add by TangramTeam
  CommonUniverse::IWebRTDelegate* m_pWebRTDelegate;
  // end Add by TangramTeam
...
class BASE_EXPORT MessagePumpForUI : public MessagePumpWin,
                                     // begin Add by TangramTeam,
                                     public CommonUniverse::AppMessagePumpForUI
// end Add by TangramTeam
{
 public:
  MessagePumpForUI();
  ...
  // begin Add by TangramTeam
  int OnProcessNextWindowsMessage(LPMSG lpMsg) override;
  // end Add by TangramTeam
