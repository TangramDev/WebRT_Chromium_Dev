...
class CONTENT_EXPORT RenderFrameHostImpl
      // begin Add by TangramTeam
      :public CommonUniverse::CChromeRenderFrameHost,
      // end Add by TangramTeam
 ...
 public:
  ...
  CString GetRenderFrameURL(int nType) override;
  CommonUniverse::IPCSession* GetIPCSession() override;
  void InsertString(CommonUniverse::IPCSession*,
                    CString key,
                    CString value) override;
  void InsertLong(CommonUniverse::IPCSession*,
                  CString key,
                  long value) override;
  void Insertint64(CommonUniverse::IPCSession*,
                   CString key,
                   __int64 value) override;
  void InsertFloat(CommonUniverse::IPCSession*,
                   CString key,
                   float value) override;
  CString GetString(CommonUniverse::IPCSession*, CString key) override;
  long GetLong(CommonUniverse::IPCSession*, CString key) override;
  __int64 Getint64(CommonUniverse::IPCSession*, CString key) override;
  float GetFloat(CommonUniverse::IPCSession*, CString key) override;
  void ShowWebPage(bool bShow) override;
  void OpenURL(CString strUrl, CString strDisposition);
  void SendCosmosMessage(CommonUniverse::IPCSession* var) override;
  void SendCosmosMessage(CommonUniverse::IPCMsg*) override;
  // IPC Message handlers.
  void OnWebRTMessage(std::wstring id,
                        std::wstring param1,
                        std::wstring param2,
                        std::wstring param3,
                        std::wstring param4,
  ...
  void OnWebRTMessage2(std::wstring id,
                         std::wstring param1,
                         long handle,
                         long nID,
                         std::wstring param4,
                         std::wstring param5);
  void OnWebRTHostIPCMsg(FrameMsg_TANGRAM_HOST_String_Map /* string map */,
